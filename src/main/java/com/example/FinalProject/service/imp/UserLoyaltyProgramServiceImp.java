...
import com.example.FinalProject.service.UserLoyaltyProgramService;
...
@Service
public class UserLoyaltyProgramServiceImp implements UserLoyaltyProgramService {

    private static final Logger log = LoggerFactory.getLogger(UserLoyaltyProgramServiceImp.class);
    private final UserLoyaltyProgramRepository userLoyaltyProgramRepository;

    public UserLoyaltyProgramServiceImp(UserLoyaltyProgramRepository userLoyaltyProgramRepository) {
